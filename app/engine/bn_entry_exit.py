...
# in_trading_window/max_trades_ok moved to app.engine.risk_guardrails
...
# Imported above under a leading-underscore alias so the call sites below
# (window_ok = _in_trading_window(now), max_trades_ok = _max_trades_ok(...))
