...
// Backtest page logic — split out of dashboard.js so the /backtest page
// carries no live-dashboard code (and vice versa). Shared helpers
// (escHtml, fmt2, toast, toggleTheme) live in /js/util.js.
